  ...
  if (loading) {
    return (
      <div className="max-w-2xl mx-auto">
        ...
        <div className="h-4 w-72 rounded-lg bg-j-light-text/5 dark:bg-white/5 animate-pulse mb-8" />
  ...
  if (notFound || !item) {
    return (
      <div className="max-w-2xl mx-auto text-center py-24">
        ...
        <p className="text-lg font-medium text-j-light-text dark:text-j-dark-text">Item no encontrado</p>
        <button
